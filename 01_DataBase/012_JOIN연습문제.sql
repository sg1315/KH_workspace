...
SELECT MIN(FLOOR((SYSDATE - TO_DATE(SUBSTR(EMP_NO,1,6),'RR/MM/DD'))/365)) AS "나이"
        FROM EMPLOYEE;
...
SELECT EMP_ID, EMP_NAME, 
         ...
         JOIN DEPARTMENT ON(DEPT_CODE = DEPT_ID)
         JOIN JOB USING(JOB_CODE)
         WHERE FLOOR((SYSDATE - TO_DATE(SUBSTR(EMP_NO,1,6),'RR/MM/DD'))/365) = (SELECT MIN(FLOOR((SYSDATE - TO_DATE(SUBSTR(EMP_NO,1,6),'RR/MM/DD'))/365)) AS "나이"
                                                                                FROM EMPLOYEE);

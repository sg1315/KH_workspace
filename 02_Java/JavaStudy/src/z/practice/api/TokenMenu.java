...
public class TokenMenu {
	...
	public void tokenMenu() {
		...
		String newToken = tc.afterToken(str);
		System.out.println("토큰 처리 후 글자 : " + newToken);
		System.out.println("토큰 처리 후 개수 : " + newToken.length());
		System.out.println("모두 대문자로 변환 : " + newToken.toUpperCase());
	}
